...
<div class="container-fluid col2 hero-header mb-5">
        <div class="container text-center">
            <h1 class="display-4 text-white mb-3 animated slideInDown">UPDATE_SERVICE</h1>
...
<div class="col-md">
    ...
    <input type="text" class="form-control" id="service" name="service" value="<?php echo $data['service_name'];?>" >
    </div>
