...
<div class="container-fluid col2 hero-header mb-5">
        <div class="container text-center">
            <h1 class="display-4 text-white mb-3 animated slideInDown">ADD_PRICE</h1>
...
include('config2.php');
$query="INSERT INTO `price_table`(`name`, `image`, `price`) VALUES ('$name','$new_name','$price')";
$result=mysqli_query($conn,$query);

if($result>0){
    echo "<script>window.location.assign('add_price.php?msg=priceaddsucessfully')</script>";
}
else{
    echo "<script>window.location.assign('add_price.php?msg=pricedoesnotaddsucessfully')</script>";
}
}
?>
